...
if __name__ == "__main__":
    ...
    parser.add_argument('--TSA_schedule', type=str, default='none', help='TSA mode: none, linear, log, exp')
    parser.add_argument('--T', type=float, default=0.4, help='Temperature sharpening')
    parser.add_argument('--ema_m', type=float, default=0.999, help='ema momentum for eval_model')
    parser.add_argument('--ulb_loss_ratio', type=float, default=1.0)
    parser.add_argument('--p_cutoff', type=float, default=0.8, help='confidencial masking threshold')
