...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # if os.path.exists(os.path.join(save_path, 'model_best.pth')):
    #     model.load_model(os.path.join(save_path, 'model_best.pth'))
    #     tsne_visualization(model, loader_dict['train_lb'], total_batch=2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='mixmatch')
    ...
    parser.add_argument('--alpha', type=float, default=0.5, help='parameter for Beta distribution of Mix Up')
    parser.add_argument('--T', type=float, default=0.5, help='parameter for Temperature Sharpening')
    parser.add_argument('--ema_m', type=float, default=0.999, help='ema momentum for eval_model')
    parser.add_argument('--ulb_loss_ratio', type=float, default=100, help='weight for unsupervised loss')
    parser.add_argument('--ramp_up', type=float, default=1 / 64, help='ramp up ratio for unsupervised loss')
