...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='meanTeacher')
    ...
    '''
    Training Configuration of MeanTeahcher
    '''
    ...
    parser.add_argument('--ulb_loss_ratio', type=float, default=50., help='weight for unsupervised loss')
